...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["education_objective_id"], ["education_objectives.id"], ondelete="SET NULL"),
...
def downgrade() -> None:
    ...
    op.drop_index("ix_ta_v2_recovery_queue_assignment", table_name="teacher_assist_v2_recovery_queue")
    op.drop_index("ix_ta_v2_recovery_queue_teacher_status", table_name="teacher_assist_v2_recovery_queue")
