"""normalize built-in strategy baseline config

Revision ID: 020_strategy_baseline_config
Revises: 019_root_admin_strategy_access
...
revision: str = "020_strategy_baseline_config"
down_revision: Union[str, None] = "019_root_admin_strategy_access"
...
BASELINE_PLATFORM_CONFIGS: dict[str, dict[str, dict[str, Any]]] = {
    "momentum": {
        ...
        "risk_caps": {"max_position_usd": 120},
    },
    "day_trading": {
        "strategy_params": {
