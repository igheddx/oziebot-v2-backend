...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint(
            "assignment_id", "student_number", name="uq_ta_v2_gradebook_assignment_student"
        ),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["gradebook_record_id"], ["teacher_assist_v2_gradebook_records.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "teacher_confirmed", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
...
def downgrade() -> None:
    op.drop_index(
        "ix_ta_v2_mastery_assignment_student", table_name="teacher_assist_v2_mastery_evidence"
    )
    op.drop_index(
        "ix_ta_v2_mastery_objective_current", table_name="teacher_assist_v2_mastery_evidence"
    )
    op.drop_table("teacher_assist_v2_mastery_evidence")
    op.drop_index(
        "ix_ta_v2_gradebook_revision_record",
        table_name="teacher_assist_v2_gradebook_record_revisions",
    )
    ...
    op.drop_index(
        "ix_ta_v2_gradebook_teacher_school_year", table_name="teacher_assist_v2_gradebook_records"
    )
