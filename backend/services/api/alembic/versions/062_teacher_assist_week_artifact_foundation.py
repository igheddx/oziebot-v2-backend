...
def upgrade() -> None:
    ...
    op.create_index("ix_assignments_pacing_guide_period_id", "assignments", ["pacing_guide_period_id"])

    op.add_column("teacher_assist_newsletters", sa.Column("pacing_guide_id", sa.Uuid(), nullable=True))
    op.add_column("teacher_assist_newsletters", sa.Column("pacing_guide_period_id", sa.Uuid(), nullable=True))
    op.create_foreign_key(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["export_artifact_id"], ["teacher_assist_export_artifacts.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["instructional_plan_id"], ["weekly_plans.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["newsletter_id"], ["teacher_assist_newsletters.id"], ondelete="SET NULL"),
        ...
        sa.ForeignKeyConstraint(["planning_draft_id"], ["planning_input_drafts.id"], ondelete="SET NULL"),
...
def downgrade() -> None:
    op.drop_index("ix_teacher_assist_generated_artifacts_artifact_type", table_name="teacher_assist_generated_artifacts")
    op.drop_index("ix_teacher_assist_generated_artifacts_period_id", table_name="teacher_assist_generated_artifacts")
    op.drop_index("ix_teacher_assist_generated_artifacts_tenant_id", table_name="teacher_assist_generated_artifacts")
    ...
    op.drop_index("ix_teacher_assist_newsletters_pacing_guide_period_id", table_name="teacher_assist_newsletters")
    op.drop_constraint(
        "fk_teacher_assist_newsletters_pacing_guide_period_id",
        "teacher_assist_newsletters",
        type_="foreignkey",
    )
    op.drop_constraint("fk_teacher_assist_newsletters_pacing_guide_id", "teacher_assist_newsletters", type_="foreignkey")
