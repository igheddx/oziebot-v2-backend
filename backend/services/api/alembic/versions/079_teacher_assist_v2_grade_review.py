...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["grading_draft_id"], ["teacher_assist_v2_grading_drafts.id"], ondelete="SET NULL"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["tenant_id"], ["tenants.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("teacher_user_id", "student_submission_id", name="uq_ta_v2_submission_review_view"),
    )


def downgrade() -> None:
    op.drop_table("teacher_assist_v2_submission_review_views")
    op.drop_index("ix_ta_v2_grade_audit_submission", table_name="teacher_assist_v2_assignment_grade_audit_events")
    op.drop_table("teacher_assist_v2_assignment_grade_audit_events")
    op.drop_index("ix_ta_v2_assignment_grades_submission", table_name="teacher_assist_v2_assignment_grades")
