...
class TeacherAssistPlanningInputDraftStandard(Base):
    __tablename__ = "planning_input_draft_standards"
    __table_args__ = (
        UniqueConstraint(
    ...
    planning_input_draft: Mapped["TeacherAssistPlanningInputDraft"] = relationship(
        "TeacherAssistPlanningInputDraft", back_populates="standard_links"
    )
