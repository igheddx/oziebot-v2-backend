...
class TokenStrategyPolicy(Base):
    ...
    size_multiplier: Mapped[float | None] = mapped_column(Numeric(12, 6), nullable=True)
    max_position_usd_override: Mapped[float | None] = mapped_column(Numeric(18, 2), nullable=True)
