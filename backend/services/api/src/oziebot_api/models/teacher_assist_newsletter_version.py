...
class TeacherAssistNewsletterVersion(Base):
    __tablename__ = "teacher_assist_newsletter_versions"
    __table_args__ = (
        UniqueConstraint("newsletter_id", "version_number", name="uq_newsletter_version_number"),
    )
