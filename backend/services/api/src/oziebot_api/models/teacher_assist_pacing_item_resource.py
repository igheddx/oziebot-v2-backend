...
class TeacherAssistPacingItemResource(Base):
    __tablename__ = "pacing_item_resources"
    __table_args__ = (
        UniqueConstraint(
            "pacing_item_id",
    ...
    pacing_item: Mapped["TeacherAssistPacingItem"] = relationship(
        "TeacherAssistPacingItem", back_populates="resource_links"
    )
    resource_library_item: Mapped["TeacherAssistResourceLibraryItem"] = relationship(
        "TeacherAssistResourceLibraryItem", back_populates="pacing_item_links"
    )
