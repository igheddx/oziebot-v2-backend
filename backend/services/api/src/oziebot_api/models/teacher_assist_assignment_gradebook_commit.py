...
class TeacherAssistAssignmentGradebookCommit(Base):
    __tablename__ = "teacher_assist_assignment_gradebook_commits"
    ...
    grade_record_id: Mapped[uuid.UUID] = mapped_column(
        Uuid(as_uuid=True),
        ForeignKey("teacher_assist_assignment_grade_records.id", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
    ...
    grade_record: Mapped["TeacherAssistAssignmentGradeRecord"] = relationship(
        "TeacherAssistAssignmentGradeRecord",
        back_populates="commits",
        foreign_keys=[grade_record_id],
    )
