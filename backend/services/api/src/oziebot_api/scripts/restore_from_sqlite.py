    ...
    (
        ...
        VALUES
          ...
          ('2609c9f7-8aec-4fe7-95f8-96e5d6200706',
           'momentum', 'Momentum', '',
           true, 'oziebot.strategies',
           '{"strategy_params":{"short_window":8,"long_window":34,"strength_threshold":0.001,"position_size":0.08},"risk_caps":{"max_position_usd":250,"max_daily_loss_pct":3.0,"max_open_positions":1},"signal_rules":{"min_confidence":0.65,"cooldown_seconds":120,"max_signals_per_day":20,"require_volume_confirmation":true}}',
          ...
          ('4f8af20f-5f87-43fe-ae0a-fcf82161db69',
           ...
           true, 'oziebot.strategies',
           '{"strategy_params":{"entry_threshold":0.008,"exit_threshold":0.015,"stop_loss":0.007,"max_position_age_hours":4},"risk_caps":{"max_position_usd":180,"max_daily_loss_pct":2.0,"max_open_positions":2},"signal_rules":{"min_confidence":0.7,"cooldown_seconds":60,"max_signals_per_day":40,"only_during_liquid_hours":true}}',
          ...
          ('b4c43bc8-5d72-aa9d-f233-179dc9d95e5e',
           ...
           true, 'oziebot.strategies',
           '{"strategy_params":{"buy_amount_usd":50,"buy_interval_hours":24,"only_on_green_days":false},"risk_caps":{"max_position_usd":600,"max_daily_loss_pct":5.0,"max_open_positions":1},"signal_rules":{"min_confidence":0.55,"cooldown_seconds":3600,"max_signals_per_day":4,"skip_if_spread_bps_over":35}}',
